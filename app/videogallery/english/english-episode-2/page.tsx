...
export default function EnglishEpisode2Page() {
          ...
          <div style={{ flex: '1', maxWidth: 'calc(100% - 340px)' }}>
            ...
            <div style={{
              ...
              {videoError ? (
                ...
                <video
                  ref={videoRef}
                  src="https://exsearchvideos.s3.eu-central-1.amazonaws.com/quentin/How+to+Read+Episode+2.mov"
                  preload="auto"
                  style={{
                    width: '100%',
                    height: '100%',
            ...
            <div style={{ 
              ...
              <Link href="/videogallery/english/english-episode-3" style={{ textDecoration: 'none' }}>
                <button style={{
                  padding: '6px 24px',
                  backgroundColor: '#FFFFFF',
                  color: '#000000',
          ...
          <div style={{ 
            ...
            <div style={{
              ...
              <span style={{
                ...
                Advanced reading strategies and comprehension techniques
              </span>
            </div>
          </div>
        </div>
        ...
        <div style={{ padding: '0 40px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '20px', marginBottom: '20px' }}>
            ...
            <div style={{ display: 'flex', gap: '15px', flex: '1', justifyContent: 'space-between' }}>
              {['Episode 1', 'Episode 2', 'Episode 3', 'Coming Soon'].map((episode, index) => (
                <Link key={index} href={index < 3 ? `/videogallery/english/english-episode-${index + 1}` : '#'} style={{ textDecoration: 'none' }}>
                  <div style={{ 
                    backgroundColor: index === 1 ? '#00CED1' : '#d0d0d0',
                    border: '1px solid #000000',
                    borderRadius: '8px',
                    height: '160px',
                    ...
                    fontSize: '14px',
                    color: index === 1 ? '#FFFFFF' : '#666666',
                    cursor: index < 3 ? 'pointer' : 'not-allowed',
                    minWidth: '200px',
