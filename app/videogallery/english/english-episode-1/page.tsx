          ...
          <div style={{ flex: '1', maxWidth: 'calc(100% - 340px)' }}>
            ...
            <div style={{
              ...
              {videoError ? (
                ...
                <video
                  ref={videoRef}
                  src="https://exsearchvideos.s3.eu-central-1.amazonaws.com/quentin/How+to+Read+Episode+1.mov"
                  preload="auto"
                  style={{
                    width: '100%',
                    height: '100%',
          ...
          <div style={{ 
            ...
            <div style={{
              ...
              <span style={{
                ...
                Understanding reading techniques and analysis methods
              </span>
            </div>
          </div>
        </div>
            ...
            <div style={{ display: 'flex', gap: '15px', flex: '1', justifyContent: 'space-between' }}>
              {['Episode 1', 'Episode 2', 'Episode 3', 'Coming Soon'].map((episode, index) => (
                <Link key={index} href={index < 3 ? `/videogallery/english/english-episode-${index + 1}` : '#'} style={{ textDecoration: 'none' }}>
                  <div style={{ 
                    backgroundColor: index === 0 ? '#00CED1' : '#d0d0d0',
                    border: '1px solid #000000',
                    borderRadius: '8px',
                    height: '160px',
